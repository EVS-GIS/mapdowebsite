...
Le projet **Mapd'O** vise à développer une [interface web](https://isig-apps.ens-lyon.fr/apps/mapdo/mapdoapp/) permettant aux opérateurs et aux scientifiques d'analyser les données et les modèles hydromorphologiques du réseau hydrographique français. Le projet est porté par le laboratoire *CNRS UMR 5600 - Environnement Ville Société (EVS)* et est soutenu par *l'Office Français de la Biodiversité* depuis janvier 2023.
...
![Aperçu de l'interface de l'application.s](imaCapture_d’écran_2024-10-14_mapdoapp.png)
